...
import 'package:login_ora/data/models/multilang_exercise.dart';
import 'package:login_ora/data/services/multilangual_exercise_service.dart';
import 'dart:math';
...
class _MultilingualExerciseScreenState
  ...
  void _initializeLesson() {
    if (widget.specificLesson != null) {
      ...
      final lessons = MultilingualExerciseService.getLessons();
      currentLesson = lessons.isNotEmpty ? lessons[0] : _createDefaultLesson();
    }
  ...
  ExerciseLesson _createDefaultLesson() {
    return ExerciseLesson(
      ...
      description: MultiLanguageText(translations: {'en': 'Practice exercises'}),
      level: 1,
      category: 'basic',
      exercises: [],
    );
  ...
  Widget _buildDifficultyIndicator() {
    return Row(
      children: [
        const Icon(Icons.trending_up, size: 20, color: const Color(0xFFFFA06B)),
      ...
      children: [
        Card(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Icon(Icons.help_outline, size: 40, color: const Color(0xFFFF6B9D)),
        ...
        Container(
          ...
          child: Wrap(
            spacing: 8,
            runSpacing: 8,
            children: orderedWords.map((word) => _buildDraggableWord(word)).toList(),
          ),
        ),
        const SizedBox(height: 16),
        SizedBox(
    ...
    return Draggable<String>(
      ...
      child: DragTarget<String>(
        onAccept: (draggedWord) {
          setState(() {
            final draggedIndex = orderedWords.indexOf(draggedWord);
            final targetIndex = orderedWords.indexOf(word);
            orderedWords.removeAt(draggedIndex);
            orderedWords.insert(targetIndex, draggedWord);
          });
        },
  ...
  Widget _buildWordChip(String word) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: const Color(0xFFFF6B9D).withOpacity(0.5), width: 2),
      ),
      child: Text(
        word,
        style: TextStyle(
            ...
            return Container(
              ...
              child: InkWell(
                ...
                child: Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                    color: isSelected ? const Color(0xFF6BCF7F).withOpacity(0.3) : Colors.white,
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
      ...
      children: [
        Card(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Icon(Icons.translate, size: 40, color: const Color(0xFFFFA06B)),
                const SizedBox(height: 12),
                Text(
                  currentExercise.question.get(widget.languageCode),
                  textAlign: TextAlign.center,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFFFF6B9D).withOpacity(0.1),
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: const Color(0xFFFF6B9D).withOpacity(0.3), width: 2),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(
                children: [
                  Icon(Icons.info_outline, color: const Color(0xFFFF6B9D)),
                  const SizedBox(width: 8),
                  const Text(
                    'Frase da tradurre:',
      ...
      children: [
        Card(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Icon(Icons.library_books, size: 40, color: Colors.red),
                const SizedBox(height: 12),
                Text(
                  currentExercise.question.get(widget.languageCode),
                  textAlign: TextAlign.center,
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [const Color(0xFFFF6B9D).shade50, const Color(0xFFFF6B9D).withOpacity(0.1)],
            ),
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: const Color(0xFFFF6B9D).shade200, width: 2),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Row(
                children: [
                  Icon(Icons.menu_book, color: const Color(0xFFFF6B9D).shade700),
                  const SizedBox(width: 8),
                  const Text(
        ...
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.tips_and_updates, color: const Color(0xFFFFD93D), size: 20),
              const SizedBox(width: 8),
              Expanded(
                child: Text(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: const Color(0xFF6BCF7F).withOpacity(0.4), width: 2),
          ),
          child: Text(
            currentExercise.sentence.get(widget.languageCode),
            style: const TextStyle(
        ...
        if (currentExercise.wordOptions != null)
          ...currentExercise.wordOptions!.map((wordOption) {
            ...
            final isCorrect = word == currentExercise.correctAnswer.get(widget.languageCode);
            ...
            if (showResult) {
              ...
              backgroundColor = isSelected ? const Color(0xFFFF6B9D).withOpacity(0.1) : Colors.white;
                  ...
                  child: Row(
                    children: [
                      ...
                      if (showResult && isCorrect)
                        const Icon(Icons.check_circle, color: const Color(0xFF6BCF7F)),
      ...
      children: [
        Card(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Icon(Icons.headphones, size: 50, color: const Color(0xFFFFA06B)),
                const SizedBox(height: 16),
                Text(
                  currentExercise.question.get(widget.languageCode),
                  textAlign: TextAlign.center,
        ...
        if (currentExercise.wordOptions != null)
          ...currentExercise.wordOptions!.map((wordOption) {
            ...
            if (showResult) {
              ...
              backgroundColor = isSelected ? const Color(0xFFFFA06B).withOpacity(0.2) : Colors.white;
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      if (showResult && isCorrect)
                        const Icon(Icons.check_circle, color: const Color(0xFF6BCF7F), size: 28),
                      if (showResult && isSelected && !isCorrect)
  ...
  Widget _buildResultFeedback() {
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: isCorrect ? const Color(0xFF6BCF7F).withOpacity(0.2) : Colors.red.withOpacity(0.2),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
              ...
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    fontWeight: FontWeight.bold,
                    color:
                        isCorrect ? const Color(0xFF6BCF7F) : Colors.red,
                  ),
                ),
              ),
            ],
  ...
  void _handleButtonPress() {
    if (!showResult) {
      ...
      if (selectedAnswer == null || selectedAnswer!.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Fornisci una risposta')),
        );
        return;
      }
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 32,
                            fontWeight: FontWeight.bold,
                            color: percentage >= 70 ? const Color(0xFF6BCF7F) : const Color(0xFFFFA06B),
                          ),
                        ),
                      ],
                    ),
