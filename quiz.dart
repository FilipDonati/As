...
class QuizScreen extends StatefulWidget {
  ...
  const QuizScreen({super.key, required this.lingua, required this.livello});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ...List.generate(
              (domanda['opzioni'] as List).length,
              (index) {
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: colore ?? (isSelezionata ? const Color(0xFF6C63FF).withOpacity(0.1) : Colors.grey[100]),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: colore ?? (isSelezionata ? const Color(0xFF6C63FF) : Colors.grey[300]!),
                          width: 2,
                        ),
                      ),
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: isSelezionata ? FontWeight.bold : FontWeight.normal,
                        ),
                      ),
                    ),
                  ),
